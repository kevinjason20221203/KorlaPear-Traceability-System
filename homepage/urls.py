...
urlpatterns = [
    ...
    # 二维码模块路由
    path('generate_qrcode/<str:Tag_number>/', generate_qrcode_for_livestock, name='generate-qrcode-for-livestock'),
    path('qrcode_list/', show_qrcode_list, name='qrcode-list'),
    path('qrcode_scanner/', qrcode_scanner, name='qrcode-scanner'),
    path('process_qrcode_scan/', process_qrcode_scan, name='process-qrcode-scan'),
    path('trace/<str:serial_number>/', trace_query, name='trace-query'),
    path('qrcode_management/<str:Tag_number>/', qrcode_management, name='qrcode-management'),
    
    # 物流追踪系统路由
    path('show_logistics_list/', show_logistics_list, name='show-logistics-list'),
    path('show_logistics_tracking/<str:Tag_number>/', show_logistics_tracking, name='show-logistics-tracking'),
    path('add_logistics_tracking/<str:Tag_number>/', add_logistics_tracking, name='add-logistics-tracking'),
    path('show_storage_list/', show_storage_list, name='show-storage-list'),
    path('add_storage/', add_storage, name='add-storage'),
    path('show_storage_detail/<int:storage_id>/', show_storage_detail, name='show-storage-detail'),
    path('add_storage_item/<int:storage_id>/', add_storage_item, name='add-storage-item'),
    path('remove_storage_item/<int:item_id>/', remove_storage_item, name='remove-storage-item'),
    path('logistics_timeline/<str:Tag_number>/', logistics_timeline, name='logistics-timeline')
]
